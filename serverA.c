...
int main(){
    ...
    printf("The Server A has the following neughbor information:\n");
    ...
    printf("The Server A finishes sending its neighbor information to the Client with TCP port number %d and IP address ", ntohs(server.sin_port));
